...
function TrackTable<T extends Track>({
  ...
  const columns = useMemo(() => [
    ...
    displayPosition && {
      ...
      Header: ({ column }) => <ColumnHeader column={column} header={<span style={{ color: 'green' }}>PositionHeader</span>} data-testid='position-header' />,
      accessor: 'position',
      Cell: PositionCell,
      enableSorting: true
    },
    ...
    },
    {
      ...
      Header: ({ column }) => <ColumnHeader column={column} header={<span style={{ color: 'green' }}>TitleHeader</span>} />,
    ...
    displayArtist && {
      ...
      Header: ({ column }) => <ColumnHeader column={column} header={<span style={{ color: 'green' }}>ArtistHeader</span>} />,

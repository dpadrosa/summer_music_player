...
export const GridTrackTable = <T extends Track>({
  ...
  const generateColumns = () => [
    ...
    displayPosition && {
      ...
      Header: ({ column }: { column: TrackTableColumnInstance<T> }) => <TextHeader<T> data-testid='position-header' column={column} header={<span style={{ color: 'yellow' }}>{positionHeader}</span>} isCentered />,
    ...
    displayThumbnail && {
      ...
      Header: ({ column }: { column: ColumnInstance<T> & UseSortByColumnProps<T>; }) => <TextHeader<T> column={column} header={<span style={{ color: 'yellow' }}>{thumbnailHeader}</span>} />,
    ...
    },
    {
      ...
      Header: ({ column }: { column: TrackTableColumnInstance<T> }) => <TextHeader<T> column={column} header={<span style={{ color: 'yellow' }}>{titleHeader}</span>} />,
    ...
    displayArtist && {
      ...
      Header: ({ column }: { column: TrackTableColumnInstance<T> }) => <TextHeader<T> column={column} header={<span style={{ color: 'yellow' }}>{artistHeader}</span>}  />,
    ...
    displayAlbum && {
      ...
      Header: ({ column }: { column: TrackTableColumnInstance<T> }) => <TextHeader<T> column={column} header={<span style={{ color: 'yellow' }}>{albumHeader}</span>}/>,
    ...
    shouldDisplayDuration && {
      ...
      Header: ({ column }: { column: TrackTableColumnInstance<T> }) => <TextHeader<T> column={column} header={<span style={{ color: 'yellow' }}>{durationHeader}</span>} />,

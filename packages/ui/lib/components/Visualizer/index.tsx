...
import { registerAudioGraph } from '../../components/utils/audioBridge';
  ...
  useEffect(() => {
    if (canvasRef.current) {
      ...
      setVisualizer(_visualizer);
       ...
       // ✅ On enregistre l’audio graph pour les autres visualiseurs
    registerAudioGraph(audioContext, previousNode);
